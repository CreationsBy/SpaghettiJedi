...
// --- NEW FIX: Logic for the Instructions Modal ---
const instructionsModal = document.getElementById('instructions-modal');
const closeInstructionsBtn = document.getElementById('close-instructions-btn');
const showInstructionsBtn = document.getElementById('show-instructions-btn');

// Show the modal if they click "How to Play"
...
// Auto-show it if this is their very first time loading the site!
...
document.body.addEventListener('pointerdown', () => {
    // Don't start music if they are just clicking the start button on the modal!
